...
(lib.Boobs = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(6).to({startPosition:0,_off:false},0).to({scaleX:1,scaleY:1,rotation:0,x:99.1,y:162.2},4,cjs.Ease.get(-0.3)).wait(70));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(6).to({startPosition:0,_off:false},0).to({regX:12,scaleX:1,scaleY:1,rotation:0,x:60,y:154.2},4,cjs.Ease.get(-0.3)).wait(70));
