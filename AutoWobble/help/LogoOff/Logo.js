...
(lib.Logo = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(34).to({startPosition:0,_off:false},0).to({scaleX:1.03,scaleY:0.99,skewX:41.1,x:182},4,cjs.Ease.get(0.34)).to({scaleX:1.04,scaleY:1.03,skewX:49.4,x:189},8,cjs.Ease.get(0.55)).to({scaleX:1,scaleY:1,skewX:0,x:160},3,cjs.Ease.get(-0.69)).wait(37).to({startPosition:0},0).to({scaleX:1.41,scaleY:0.73,rotation:1.4,x:168,y:419,alpha:0},6,cjs.Ease.get(0.36)).to({_off:true},1).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(13).to({startPosition:0,_off:false},0).to({scaleX:1,scaleY:1,rotation:0,y:240,alpha:1},3,cjs.Ease.get(-0.55)).wait(70).to({startPosition:0},0).to({scaleX:0.89,scaleY:1.77,rotation:-8.3,x:149,y:224,alpha:0},6,cjs.Ease.get(0.36)).to({_off:true},1).wait(2));
